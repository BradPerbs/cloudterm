...
export default {
    ...
    'snippets.emptyNote': 'Guarde os comandos que reescreve em todas as máquinas, e as instruções que dá ao agente de IA.',
    'snippets.newPackage': 'Novo pacote',
    'snippets.newSnippet': 'Novo excerto',
    'snippets.newSpec': 'Nova especificação',
    ...
    'snippets.kind.spec': 'Só especificações',
    ...
    'assistant.tabMenu': 'Conversas e janelas',
    'assistant.windows': 'Janelas',
    'assistant.closePanel': 'Fechar painel',
    'assistant.detachOnly': 'Abrir numa janela própria',
    'assistant.detachTab': 'Mover este separador para uma janela própria',
    'assistant.detachAll': 'Mover todos os separadores para uma janela',
    'assistant.detachEach': 'Cada separador na sua própria janela',
    'assistant.reattach': 'Voltar à janela principal',
    'assistant.reattachTab': 'Mover este separador de volta à janela principal',
    'assistant.reattachAll': 'Mover todos os separadores de volta à janela principal',
    ...
    'assistant.askQuestion': 'Uma pergunta para si',
    'assistant.skipQuestion': 'Ignorar a pergunta',
    'assistant.answerPlaceholder': 'A sua resposta',
