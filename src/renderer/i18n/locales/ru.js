...
export default {
    ...
    'snippets.emptyNote': 'Сохраните команды, которые набираете заново на каждой машине, и инструкции, которые даёте ИИ-агенту.',
    'snippets.newPackage': 'Новый пакет',
    'snippets.newSnippet': 'Новый сниппет',
    'snippets.newSpec': 'Новая спецификация',
    ...
    'snippets.kind.spec': 'Только спецификации',
    ...
    'settings.assistant.localToolsDesc': 'Позволяет ассистенту читать и записывать локальные файлы '
        + 'и выполнять локальные команды, каждый раз сначала запрашивая подтверждение. Выключите, '
        + 'чтобы панель работала только с серверами. Поиск в интернете доступен в любом случае.',
    ...
    'assistant.attachImage': 'Добавить изображение',
    ...
    'assistant.tabMenu': 'Разговоры и окна',
    'assistant.windows': 'Окна',
    'assistant.closePanel': 'Закрыть панель',
    'assistant.detachOnly': 'Открыть в отдельном окне',
    'assistant.detachTab': 'Вынести эту вкладку в отдельное окно',
    'assistant.detachAll': 'Вынести все вкладки в окно',
    'assistant.detachEach': 'Каждую вкладку в своё окно',
    'assistant.reattach': 'Вернуть в главное окно',
    'assistant.reattachTab': 'Вернуть эту вкладку в главное окно',
    'assistant.reattachAll': 'Вернуть все вкладки в главное окно',
    ...
    'assistant.askQuestion': 'Вопрос к вам',
    'assistant.skipQuestion': 'Пропустить вопрос',
