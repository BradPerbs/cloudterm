...
export default {
    ...
    'snippets.emptyNote': 'Save the commands you retype on every box, and the instructions you hand the AI agent.',
    'snippets.newPackage': 'New package',
    'snippets.newSnippet': 'New Snippet',
    'snippets.newSpec': 'New spec',
    ...
    'assistant.tabMenu': 'Chats and windows',
    'assistant.windows': 'Windows',
    ...
    'assistant.reattachTab': 'Move this tab back to the main window',
    'assistant.reattachAll': 'Move all tabs back to the main window',
    'assistant.stop': 'Stop',
    ...
    'assistant.askQuestion': 'A question for you',
    'assistant.skipQuestion': 'Skip the question',
