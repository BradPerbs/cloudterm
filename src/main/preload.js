...
contextBridge.exposeInMainWorld('api', {
    ...
    updates: {
        // A notice and a link, nothing more: no download and no install crosses
        // this bridge, because nothing here can check a binary's signature.
        ...
        // The daily check is not one the renderer asked for, and a check
        // started from Settings has to reach the bell in the title bar.
