...
function register(getWindow) {
    ...
    // Only the selections cross the bridge; the files are re-read here, so no
    // host key or private key is ever taken on the renderer's word.
